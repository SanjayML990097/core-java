class InductionCook{
    public static void main(String args[]) {
        ...
        String productName = "Induction Cooktop";
        String modelNumber = "HD4928/01";
        int powerWatts = 2100;
        String bodyMaterial = "Micro Crystal Plate";
        String controlType = "Push Button";
        String displayType = "LED";
        int presetCookingMenus = 6;
        boolean timerAvailable = true;
        String maxTimerSetting = "3 Hours";
        boolean fastHeating = true;
        String countryOfBrand = "Netherlands"; 
