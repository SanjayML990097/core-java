class Swiggy {
    ...
    public static double search(String foodName) {
        ...
        if (foodName == "burger") 
		{
			...
			price = 150.0;
			return price;
		}else if (foodName == "sandwich") { price = 80.0; return price; }
        else if (foodName == "fries") { price = 70.0; return price; }
        else if (foodName == "noodles") { price = 110.0; return price; }
        else if (foodName == "friedRice") { price = 130.0; return price; }
        else if (foodName == "biryani") { price = 180.0; return price; }
        else if (foodName == "shawarma") { price = 140.0; return price; }
        else if (foodName == "momos") { price = 90.0; return price; }
        else if (foodName == "paneerTikka") { price = 170.0; return price; }
        else if (foodName == "vegRoll") { price = 85.0; return price; }
        else if (foodName == "chickenRoll") { price = 120.0; return price; }
        else if (foodName == "dosa") { price = 60.0; return price; }
